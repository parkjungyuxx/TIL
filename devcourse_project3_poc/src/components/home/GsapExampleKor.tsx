    ...
    <div className="bg-white min-h-screen">
      ...
      >
        <div className="w-[1320px] text-center">
          ...
          >
            당신의 창의력을 펼치고, 다양한 사람들과 실시간 그림 대결을
            펼쳐보세요.
          </p>
          ...
          <div className="text-lg md:text-xl text-gray-500 font-medium h-8 overflow-hidden relative w-full max-w-lg mx-auto mt-24">
            <div
              ref={slidingTextRef}
      ...
      <section className="py-10 px-6">
        <div className="max-w-6xl mx-auto">
          ...
          >
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">Community</p>
          </div>
        </div>
      </section>
